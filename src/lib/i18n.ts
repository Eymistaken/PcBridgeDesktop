...
const en: Record<string, string> = {
  ...
  "side.pluginCount_one": "{n} plugin",
  "side.pluginCount_other": "{n} plugins",
  "plg.title": "Plugins",
  "plg.what":
    "Extra MCP servers. Their tools appear in the bot form next to pcbridge’s, prefixed with the plugin name.",
  "plg.empty":
    "No plugins yet. Add one and a bot can reach whatever it exposes — mail, notes, a database — alongside this machine.",
  "plg.builtin": "built in · cannot be removed",
  "plg.name": "Name",
  "plg.command": "Command",
  "plg.args": "Arguments",
  "plg.argsHint": "One per line.",
  "plg.add": "Add",
  "plg.adding": "connecting…",
  "plg.save": "Save",
  "plg.cancel": "Cancel",
  "plg.edit": "Edit",
  "plg.remove": "Remove",
  "plg.reconnect": "Reconnect",
  "plg.connecting": "connecting…",
  "plg.connected_one": "connected · {n} tool",
  "plg.connected_other": "connected · {n} tools",
  "plg.off": "off",
  "plg.down": "not connected",
  "plg.enable": "On",
  "plg.newTitle": "New plugin",
  "plg.firstRunHint":
    "The first run of an npx server downloads it. That needs a network connection; the app keeps working if it fails.",
  "plg.secretsHint":
...
const tr: Record<string, string> = {
  ...
  "side.pluginCount_one": "{n} eklenti",
  "side.pluginCount_other": "{n} eklenti",
  "plg.title": "Eklentiler",
  "plg.what":
    "Ek MCP sunucuları. Araçları bot formunda pcbridge’inkilerin yanında, eklenti adıyla öneklenmiş olarak görünür.",
  "plg.empty":
    "Henüz eklenti yok. Bir tane eklerseniz bot, bu makinenin yanında onun açtığı şeye de uzanabilir — posta, not, veritabanı.",
  "plg.builtin": "gömülü · kaldırılamaz",
  "plg.name": "Ad",
  "plg.command": "Komut",
  "plg.args": "Argümanlar",
  "plg.argsHint": "Her satıra bir tane.",
  "plg.add": "Ekle",
  "plg.adding": "bağlanıyor…",
  "plg.save": "Kaydet",
  "plg.cancel": "Vazgeç",
  "plg.edit": "Düzenle",
  "plg.remove": "Kaldır",
  "plg.reconnect": "Yeniden bağlan",
  "plg.connecting": "bağlanıyor…",
  "plg.connected_one": "bağlı · {n} araç",
  "plg.connected_other": "bağlı · {n} araç",
  "plg.off": "kapalı",
  "plg.down": "bağlı değil",
  "plg.enable": "Açık",
  "plg.newTitle": "Yeni eklenti",
  "plg.firstRunHint":
    "npx ile çalışan bir sunucu ilk seferde ağdan iner. Bu bir ağ bağlantısı ister; inmezse uygulama çalışmaya devam eder.",
  "plg.secretsHint":
