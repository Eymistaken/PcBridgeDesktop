...
const en: Record<string, string> = {
  ...
  "panes.dragHint": "Drag onto another pane to swap them",
  "panes.izgara": "Grid",
  "panes.sutunlar": "Columns",
  "panes.satirlar": "Rows",
  ...
  "area.n": "Area {n}",
  "area.tabs": "Workspaces",
  "area.new": "New workspace",
  "area.close": "Close workspace",
  "area.menu": "Workspace menu",
  "area.tabTitle": "{name} — {n} pane(s). Double-click to rename.",
  ...
  "menu.folder": "Change folder…",
  "panes.folder": "Change folder",
  "panes.folderNamed": "Change the folder of pane {name}",
  "panes.chooseDir": "Choose a folder for this pane",
  "panes.cliTitle": "A program is running in this pane",
  "panes.cliAsk": "{cmd} is running here",
  "panes.cliBlurb": "A running program's working directory cannot be changed from the outside — that is a rule of the operating system, not a limitation of this app. Opening a new window in {dir} leaves {cmd} running in the current one; the counter in the header takes you back.",
  "panes.cliNewWindow": "Open a new window",
  "panes.cliSend": "Send cd anyway",
  "panes.cliSendHint": "The text goes to {cmd}, not to a shell.",
  "panes.cliCancel": "Cancel",
  "panes.windowCount": "{i}/{n}",
  "panes.nextWindow": "Next window ({i}/{n})",
  ...
  // Döküm oluk etiketleri — mono, büyük harf. Kısa tutuluyor: oluk 104px.
  "think.collapse": "collapse",
  "think.expand": "expand",
  "chat.exportShort": "Export",
  "chat.sendShort": "Send",
  "chat.attachShort": "Attach",
  "panes.serbest": "FREE",
  "forge.toolGroup.read.note": "Runs without asking — changes nothing.",
  "forge.toolGroup.write.note": "Changes the disk and processes.",
  "forge.toolGroup.desktop.note": "Pointer, keyboard, screen. The lock must also be open.",
  "welcome.server": "SERVER",
  "welcome.needs": "needs: tmux · a Secret Service provider · pcbridge 0.4+",
  "welcome.envHint": "override the endpoint with PCBRIDGE_MCP_ENDPOINT",
  ...
  "home.sessionNo": "SESSION {n}",
  "chat.gYou": "YOU",
  "chat.gReply": "REPLY",
  "chat.gThought": "THOUGHT",
  "chat.gTools": "TOOLS",
  "chat.gRaw": "RAW",
  "chat.gSummary": "SUMMARY",
  "chat.gError": "ERROR",
  "chat.gAsking": "ASKING",
  "chat.stOk": "OK",
  "chat.stErr": "ERR",
  ...
  "forge.model": "Model",
  "forge.tabs": "Bot settings",
  "forge.tab_kimlik": "Identity",
  "forge.tab_motor": "Engine",
  "forge.tab_araclar": "Tools & access",
  "forge.tab_calisma": "Working",
  "forge.effort": "Effort",
  ...
  "sys.note": "Note: {note}",
  "sys.secDesktop": "Desktop access",
  "sys.secConnection": "Connection",
  "sys.secModel": "Model server",
  "sys.secAgents": "Agents",
  "sys.secAppearance": "Appearance",
  "sys.secShortcuts": "Shortcuts",
...
const tr: Record<string, string> = {
  ...
  "panes.add": "Bölme ekle",
  "panes.splitRight": "Sağa böl",
  "panes.splitDown": "Aşağı böl",
  "panes.dragHint": "Tutup başka bir bölmenin üstüne bırak — yerleri değişir",
  "panes.izgara": "Izgara",
  "panes.sutunlar": "Sütunlar",
  ...
  "area.n": "Alan {n}",
  "area.tabs": "Çalışma alanları",
  "area.new": "Yeni çalışma alanı",
  "area.close": "Çalışma alanını kapat",
  "area.menu": "Çalışma alanı menüsü",
  "area.tabTitle": "{name} — {n} bölme. Adı değiştirmek için çift tıkla.",
  ...
  "menu.folder": "Klasör değiştir…",
  "panes.folder": "Klasör değiştir",
  "panes.folderNamed": "{name} bölmesinin klasörünü değiştir",
  "panes.chooseDir": "Bu bölme için bir klasör seç",
  "panes.cliTitle": "Bu bölmede bir program çalışıyor",
  "panes.cliAsk": "Burada {cmd} çalışıyor",
  "panes.cliBlurb": "Çalışan bir programın çalışma dizini dışarıdan değiştirilemez — bu işletim sisteminin kuralı, uygulamanın eksiği değil. {dir} dizininde yeni bir pencere açmak {cmd}'i şu anki pencerede bırakır; başlıktaki sayaç geri götürür.",
  "panes.cliNewWindow": "Yeni pencerede aç",
  "panes.cliSend": "Yine de cd gönder",
  "panes.cliSendHint": "Metin kabuğa değil {cmd}'e gider.",
  "panes.cliCancel": "İptal",
  "panes.windowCount": "{i}/{n}",
  "panes.nextWindow": "Sonraki pencere ({i}/{n})",
  ...
  // Döküm oluk etiketleri — mono, büyük harf. Kısa tutuluyor: oluk 104px.
  "think.collapse": "kapat",
  "think.expand": "aç",
  "chat.exportShort": "Dışa aktar",
  "chat.sendShort": "Gönder",
  "chat.attachShort": "Ekle",
  "panes.serbest": "SERBEST",
  "forge.toolGroup.read.note": "Sormadan çalışır — hiçbir şeyi değiştirmez.",
  "forge.toolGroup.write.note": "Diski ve süreçleri değiştirir.",
  "forge.toolGroup.desktop.note": "Fare, klavye, ekran. Ayrıca kilidin açık olması gerekir.",
  "welcome.server": "SUNUCU",
  "welcome.needs": "gerekli: tmux · bir Secret Service sağlayıcısı · pcbridge 0.4+",
  "welcome.envHint": "adresi PCBRIDGE_MCP_ENDPOINT ile değiştirebilirsin",
  ...
  "chat.gYou": "SEN",
  "chat.gReply": "YANIT",
  "chat.gThought": "DÜŞÜNCE",
  "chat.gTools": "ARAÇLAR",
  "chat.gRaw": "HAM",
  "chat.gSummary": "ÖZET",
  "chat.gError": "HATA",
  "chat.gAsking": "SORUYOR",
  "chat.stOk": "TMM",
  "chat.stErr": "HTA",
  ...
  "forge.model": "Model",
  "forge.tabs": "Bot ayarları",
  "forge.tab_kimlik": "Kimlik",
  "forge.tab_motor": "Motor",
  "forge.tab_araclar": "Araçlar & izin",
  "forge.tab_calisma": "Çalışma",
  "forge.effort": "Effort",
  ...
  "sys.note": "Not: {note}",
  "sys.secDesktop": "Masaüstü izni",
  "sys.secConnection": "Bağlantı",
  "sys.secModel": "Model sunucusu",
  "sys.secAgents": "Ajanlar",
  "sys.secAppearance": "Görünüm",
  "sys.secShortcuts": "Kısayollar",
